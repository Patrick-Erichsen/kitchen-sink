// Generated by scripts/sync-surface.mjs from openclaw 2026.5.26. Do not edit by hand.
...
export function registerAllRegistrars(api) {
  ...
  safeRegister("registerHostedMediaResolver", () => api.registerHostedMediaResolver(payloadFor("registerHostedMediaResolver")));
  ...
  safeRegister("registerSessionAction", () => api.registerSessionAction(payloadFor("registerSessionAction")));
  ...
  safeRegister("registerTranscriptSourceProvider", () => api.registerTranscriptSourceProvider(payloadFor("registerTranscriptSourceProvider")));
